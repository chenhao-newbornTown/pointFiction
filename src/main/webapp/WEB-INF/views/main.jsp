...
<div data-options="region:'north',border:false " style="height:40px;padding:0px;overflow-x:hidden;overflow-y:hidden  ">
    <div style="background-color:#1ea4d2;height:40px;overflow-y:hidden;overflow-x:hidden ">
        ...
        <div style="font-size:12px;width:40px;color:#ffffff;height:40px;line-height:40px;float:right;padding:8px">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-logout'" title="exit"
               href="<c:url value='/admin_login'/>"></a>
...
<div data-options="region:'west',split:true,iconCls:'icon-menu',title:' &nbsp;&nbsp;我的菜单 '"
     style="width:180px;padding:0px;background-color:#ffffff"
     class="panel-body panel-body-noheader layout-body panel-noscroll">
    <iframe src="/menu" frameborder="no" border="0" marginwidth="0" marginheight="0" name="leftFrame"
            style="width:100%;height:100%" scrolling="auto" target="mainFrame" noresize="noresize"></iframe>
</div>

<div data-options="region:'center'" id="righttitle" style="background-color:#ffffff">
    <div data-options="region:'center',tools:'#tab-tools'" name="optionbar" style="background-color:#ffffff"
         id="centertab"
         class="easyui-tabs " fit="true" class="easyui-tabs tabs-container easyui-fluid" border="false"
         style="padding:0px;">
    </div>
    <div id="tab-tools" style="border-left: 0px;border-top: 0px;border-right: 0px;">
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'"
           onclick="$('body').layout('full');"></a>
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'"
           onclick="$('body').layout('unFull');"></a>
    </div>
</div>


<div id="w" class="easyui-window" closed="true" align="center" ></div>
    ...
    function addPaneltab(tname, turl) {//不重复打开已打开的标签
        ...
        if ($("#centertab").tabs("exists", tname)) {//是否存在特定的 panel
            ...
            $('#centertab').tabs('update', {
                tab: current_tab,
                options: {
                    content: '<div style="padding:0px;overflow-y:hidden;" id="f"><iframe frameborder=0 width=100% height=' + lenheight + ' src=' + turl + ' frameborder="10px" scrolling="auto" noresize="noresize"></iframe></div>'
                }
            });
        } else {
            $("#centertab").tabs("add", {
